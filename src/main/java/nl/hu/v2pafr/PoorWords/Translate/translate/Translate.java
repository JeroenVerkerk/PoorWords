 ...
 */
package nl.hu.v2pafr.PoorWords.Translate.translate;

import nl.hu.v2pafr.PoorWords.Translate.ApiKeys;
import nl.hu.v2pafr.PoorWords.Translate.YandexTranslatorAPI;
...
public final class Translate extends YandexTranslatorAPI {
  ...
  public static void main(String[] args) {
    try {
      Translate.setKey(ApiKeys.YANDEX_API_KEY);
      String translation = Translate.execute("de man eet de boer", Language.DUTCH, Language.SPANISH);
